" Vim color file - catlantean
" Generated by http://bytefluent.com/vivify 2020-12-02
...
" either type '85j' or see if you can find a magic leprechaun
" in this dictionary
if !exists('s:rgb_map')
  let s:rgb_map = {
...
function! s:hi(item, fg, bg)
  ...
  let l:fg_xterm = (a:fg=='NONE')?'NONE':get(s:shark_colors_256, a:fg, 160)[l:i]
  let l:fg_rgb = (a:fg=='NONE')?'NONE':get(s:rgb_map, l:fg_xterm, '#d70000')
  let l:bg_xterm = (a:bg=='NONE')?'NONE':get(s:shark_colors_256, a:bg, 160)[l:i]
...
call s:hi("User1", "White", "RoyalBlue")
call s:hi("User2", "DarkSlateBlue", "LightGrey")
call s:hi("User3", "White", "DarkSlateBlue")
